...
<main class="secretary-main">
    ...
    <div class="dashboard-grid">
        ...
        <div class="card-amministrativa"><div><h3>💰 Cassa e Tariffe</h3><p>Controlla pagamenti, spese e contabilità.</p></div><a href="{$request.contextPath}/home/contabilita" class="btn-dashboard btn-purple">Apri Cassa</a></div>
    </div>
</main>
